...
{% hint style="info" %}
Service accounts are managed through the Apolo CLI and the platform API. Unlike the other pre-installed apps, they have no screen in the Apolo Console yet.
{% endhint %}
